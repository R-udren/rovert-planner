  ...
  <div class="w-full fixed bottom-0 left-0 right-0 bg-zinc-900 px-4 py-3">
    ...
    <form @submit="handleSubmit" class="max-w-3xl mx-auto flex">
      <input
        ...
        :disabled="disabled"
        class="flex-1 px-3 py-2 text-md rounded-xl shadow-md border border-zinc-600 bg-zinc-700 text-white placeholder-zinc-400 focus:outline-none focus:border-blue-400"
      />
      <button
        type="submit"
        :disabled="disabled"
